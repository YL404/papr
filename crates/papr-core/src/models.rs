...
pub struct ArticleDetail {
    ...
    /// `None` for summaries generated by builds that predate them.
    pub ai_summary_model: Option<String>,
    pub ai_summary_ms: Option<i64>,
    /// Total tokens (input + output); `None` when the provider reported none.
    pub ai_summary_tokens: Option<i64>,
